...
public class GolampiParser extends Parser {
	...
	public static final int
		...
		T__45=46, LE=47, GE=48, LT=49, GT=50, EQ=51, NEQ=52, ID=53, INT=54, FLOAT=55, 
		STRING=56, CHAR=57, DOT=58, COMMENT=59, MULTICOMMENT=60, WS=61;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"';'", "'break'", "'continue'", "'return'", "'int32'", "'float32'", "'bool'", 
			"'string'", "'rune'", "'['", "']'", "'||'", "'&&'", "'+'", "'-'", "'/'", 
			"'%'", "'!'", "'&'", "'true'", "'false'", "'nil'", "'<='", "'>='", "'<'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, "LE", 
			"GE", "LT", "GT", "EQ", "NEQ", "ID", "INT", "FLOAT", "STRING", "CHAR", 
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 9007199742623778L) != 0)) {
				{
				{
				setState(181);
				statement();
	...
	public final ForClassicContext forClassic() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 279360066094661760L) != 0)) {
				{
				setState(273);
				expression();
				}
	...
	public static class RelationalContext extends ParserRuleContext {
		...
		public List<TerminalNode> GE() { return getTokens(GolampiParser.GE); }
		public TerminalNode GE(int i) {
			return getToken(GolampiParser.GE, i);
		}
		public List<TerminalNode> LE() { return getTokens(GolampiParser.LE); }
		public TerminalNode LE(int i) {
			return getToken(GolampiParser.LE, i);
		}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(376);
					_la = _input.LA(1);
					if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 3298534916096L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final UnaryContext unary() throws RecognitionException {
		...
		try {
			...
			case T__42:
				...
				setState(383);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 13743895379968L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(423);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 270339122944540672L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
